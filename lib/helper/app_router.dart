...
class AppRouter{
  ...
  late SimilarMoviesCubit similarMoviesCubit;
  ...
  AppRouter(){
    ...
    similarMoviesCubit = SimilarMoviesCubit(movieDetailsRepository);
  ...
  Route? generateRoute(RouteSettings settings){
    switch (settings.name){
      ...
      case MovieTrailersPage:
        final movieTrailer = settings.arguments as MovieTrailerModel;
        return  MaterialPageRoute(
          builder:(_)=>MovieTrailersScreen(videoID: movieTrailer.key)
      );
    }
  }
}
